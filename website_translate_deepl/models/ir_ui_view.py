...
class IrUiView(models.Model):
    ...
    def remove_translation(self, target_lang_id):
        """
        Remove the view translations for the given language
        ...
        for field in field_list:
            if field["value"]:
                updated_fields[target_lang_id.code].update(
                    {
                        # reverse the key and value to remove the translation, odoo does the same
