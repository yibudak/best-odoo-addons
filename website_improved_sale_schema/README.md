...
[![Odoo Apps Store](https://img.shields.io/badge/Odoo%20Apps%20Store-714b67?style=for-the-badge)](https://apps.odoo.com/apps/modules/16.0/website_improved_sale_schema/)

# Website Improved Sale Schema

This module improves the sale schema of the website product page. It also fixes the warnings
that Google Structured Data Testing Tool reports.

## Features:

- Adds brand name, delivery deadline, price validity fields.
- Adds missing schema.org fields to the product page.

## Installation:

1. Clone this repository.
2. Add this directory to your addons path (e.g. `--addons-path=addons,path/to/this/repo`).
3. Install the module `website_improved_sale_schema`.
4. Modify the new fields on the website configuration page.
